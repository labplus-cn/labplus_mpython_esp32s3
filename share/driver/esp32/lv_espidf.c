 ...
 *
 * Command line:
 * /home/jiang/share/lv_micropython/lib/lv_bindings/gen/gen_mpy.py -M espidf -MD /home/jiang/share/lv_micropython/ports/esp32/build-GENERIC_SPIRAM/lv_espidf.c.json -E /home/jiang/share/lv_micropython/ports/esp32/build-GENERIC_SPIRAM/lv_espidf.c.pp.filtered -J /home/jiang/share/lv_micropython/ports/esp32/build-GENERIC_SPIRAM/lvgl_all.json /home/jiang/share/lv_micropython/lib/lv_bindings/driver/esp32/espidf.h
 *
...
#include "/home/jiang/share/lv_micropython/lib/lv_bindings/driver/esp32/espidf.h"
...
/*
 * espidf ADC_DIGI_FORMAT object definitions
 */
    

STATIC const mp_rom_map_elem_t ADC_DIGI_FORMAT_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR__12BIT), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FORMAT_12BIT)) },
    { MP_ROM_QSTR(MP_QSTR__11BIT), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FORMAT_11BIT)) },
    { MP_ROM_QSTR(MP_QSTR_MAX), MP_ROM_PTR(MP_ROM_INT(ADC_DIGI_FORMAT_MAX)) }
};

STATIC MP_DEFINE_CONST_DICT(ADC_DIGI_FORMAT_locals_dict, ADC_DIGI_FORMAT_locals_dict_table);

STATIC void ADC_DIGI_FORMAT_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "espidf ADC_DIGI_FORMAT");
}



STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_lv_ADC_DIGI_FORMAT_type_base,
    MP_QSTR_ADC_DIGI_FORMAT,
    MP_TYPE_FLAG_NONE,
    print, ADC_DIGI_FORMAT_print,
    
    
    attr, call_parent_methods,
    
    
    locals_dict, &ADC_DIGI_FORMAT_locals_dict
);

GENMPY_UNUSED STATIC const mp_lv_obj_type_t mp_lv_ADC_DIGI_FORMAT_type = {
#ifdef LV_OBJ_T
    .lv_obj_class = NULL,
#endif
    .mp_obj_type = &mp_lv_ADC_DIGI_FORMAT_type_base,
};
...
STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_lv_PDM_PCM_CONV_type_base,
    MP_QSTR_PDM_PCM_CONV,
    MP_TYPE_FLAG_NONE,
    ...
    locals_dict, &PDM_PCM_CONV_locals_dict
);

GENMPY_UNUSED STATIC const mp_lv_obj_type_t mp_lv_PDM_PCM_CONV_type = {
#ifdef LV_OBJ_T
    .lv_obj_class = NULL,
#endif
    .mp_obj_type = &mp_lv_PDM_PCM_CONV_type_base,
};
...
STATIC MP_DEFINE_CONST_OBJ_TYPE(
    ...
    locals_dict, &PCNT_MODE_locals_dict
);

GENMPY_UNUSED STATIC const mp_lv_obj_type_t mp_lv_PCNT_MODE_type = {
#ifdef LV_OBJ_T
    .lv_obj_class = NULL,
#endif
    .mp_obj_type = &mp_lv_PCNT_MODE_type_base,
};
...
STATIC MP_DEFINE_CONST_OBJ_TYPE(
    ...
    locals_dict, &PCNT_COUNT_locals_dict
);

GENMPY_UNUSED STATIC const mp_lv_obj_type_t mp_lv_PCNT_COUNT_type = {
#ifdef LV_OBJ_T
    .lv_obj_class = NULL,
#endif
    .mp_obj_type = &mp_lv_PCNT_COUNT_type_base,
};
...
STATIC inline const mp_obj_type_t *get_mp_adc_digi_pattern_table_t_type();

STATIC inline void* mp_write_ptr_adc_digi_pattern_table_t(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_adc_digi_pattern_table_t_type()));
    return (adc_digi_pattern_table_t*)self->data;
}

#define mp_write_adc_digi_pattern_table_t(struct_obj) *((adc_digi_pattern_table_t*)mp_write_ptr_adc_digi_pattern_table_t(struct_obj))

STATIC inline mp_obj_t mp_read_ptr_adc_digi_pattern_table_t(void *field)
{
    return lv_to_mp_struct(get_mp_adc_digi_pattern_table_t_type(), field);
}

#define mp_read_adc_digi_pattern_table_t(field) mp_read_ptr_adc_digi_pattern_table_t(copy_buffer(&field, sizeof(adc_digi_pattern_table_t)))
#define mp_read_byref_adc_digi_pattern_table_t(field) mp_read_ptr_adc_digi_pattern_table_t(&field)

STATIC void mp_adc_digi_pattern_table_t_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(self_in);
    GENMPY_UNUSED adc_digi_pattern_table_t *data = (adc_digi_pattern_table_t*)self->data;
    ...
    if (dest[0] == MP_OBJ_NULL) {
        ...
        switch(attr)
        {
            ...
            case MP_QSTR_val: dest[0] = mp_obj_new_int_from_uint(data->val); break; // converting from uint8_t;
            default: call_parent_methods(self_in, attr, dest); // fallback to locals_dict lookup
        }
    } else {
        if (dest[1])
        {
            ...
            switch(attr)
            {
                ...
                case MP_QSTR_val: data->val = (uint8_t)mp_obj_get_int(dest[1]); break; // converting to uint8_t;
                default: return;
            }
...
STATIC void mp_adc_digi_pattern_table_t_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "struct adc_digi_pattern_table_t");
}

STATIC const mp_obj_dict_t mp_adc_digi_pattern_table_t_locals_dict;

STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_adc_digi_pattern_table_t_type,
    MP_QSTR_adc_digi_pattern_table_t,
    MP_TYPE_FLAG_NONE,
    print, mp_adc_digi_pattern_table_t_print,
    make_new, make_new_lv_struct,
    binary_op, lv_struct_binary_op,
    subscr, lv_struct_subscr,
    attr, mp_adc_digi_pattern_table_t_attr,
    locals_dict, &mp_adc_digi_pattern_table_t_locals_dict,
    buffer, mp_blob_get_buffer,
    parent, &mp_lv_base_struct_type
);
...
STATIC inline const mp_obj_type_t *get_mp_adc_digi_pattern_table_t_type()
{
    return &mp_adc_digi_pattern_table_t_type;
}
...
STATIC inline const mp_obj_type_t *get_mp_adc_digi_config_t_type();

STATIC inline void* mp_write_ptr_adc_digi_config_t(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_adc_digi_config_t_type()));
    return (adc_digi_config_t*)self->data;
}

#define mp_write_adc_digi_config_t(struct_obj) *((adc_digi_config_t*)mp_write_ptr_adc_digi_config_t(struct_obj))

STATIC inline mp_obj_t mp_read_ptr_adc_digi_config_t(void *field)
{
    return lv_to_mp_struct(get_mp_adc_digi_config_t_type(), field);
}

#define mp_read_adc_digi_config_t(field) mp_read_ptr_adc_digi_config_t(copy_buffer(&field, sizeof(adc_digi_config_t)))
#define mp_read_byref_adc_digi_config_t(field) mp_read_ptr_adc_digi_config_t(&field)

STATIC void mp_adc_digi_config_t_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(self_in);
    GENMPY_UNUSED adc_digi_config_t *data = (adc_digi_config_t*)self->data;
    ...
    if (dest[0] == MP_OBJ_NULL) {
        ...
        switch(attr)
        {
            ...
            case MP_QSTR_adc1_pattern_len: dest[0] = mp_obj_new_int_from_uint(data->adc1_pattern_len); break; // converting from uint32_t;
            case MP_QSTR_adc2_pattern_len: dest[0] = mp_obj_new_int_from_uint(data->adc2_pattern_len); break; // converting from uint32_t;
            case MP_QSTR_adc1_pattern: dest[0] = mp_read_ptr_adc_digi_pattern_table_t((void*)data->adc1_pattern); break; // converting from adc_digi_pattern_table_t *;
            case MP_QSTR_adc2_pattern: dest[0] = mp_read_ptr_adc_digi_pattern_table_t((void*)data->adc2_pattern); break; // converting from adc_digi_pattern_table_t *;
        ...
        if (dest[1])
        {
            ...
            switch(attr)
            {
                ...
                case MP_QSTR_adc1_pattern_len: data->adc1_pattern_len = (uint32_t)mp_obj_get_int(dest[1]); break; // converting to uint32_t;
                case MP_QSTR_adc2_pattern_len: data->adc2_pattern_len = (uint32_t)mp_obj_get_int(dest[1]); break; // converting to uint32_t;
                case MP_QSTR_adc1_pattern: data->adc1_pattern = (void*)mp_write_ptr_adc_digi_pattern_table_t(dest[1]); break; // converting to adc_digi_pattern_table_t *;
                case MP_QSTR_adc2_pattern: data->adc2_pattern = (void*)mp_write_ptr_adc_digi_pattern_table_t(dest[1]); break; // converting to adc_digi_pattern_table_t *;
...
STATIC void mp_adc_digi_config_t_print(const mp_print_t *print,
    mp_obj_t self_in,
    mp_print_kind_t kind)
{
    mp_printf(print, "struct adc_digi_config_t");
}

STATIC const mp_obj_dict_t mp_adc_digi_config_t_locals_dict;

STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_adc_digi_config_t_type,
    MP_QSTR_adc_digi_config_t,
    MP_TYPE_FLAG_NONE,
    print, mp_adc_digi_config_t_print,
    make_new, make_new_lv_struct,
    binary_op, lv_struct_binary_op,
    subscr, lv_struct_subscr,
    attr, mp_adc_digi_config_t_attr,
    locals_dict, &mp_adc_digi_config_t_locals_dict,
    buffer, mp_blob_get_buffer,
    parent, &mp_lv_base_struct_type
);
...
STATIC inline const mp_obj_type_t *get_mp_adc_digi_config_t_type()
{
    return &mp_adc_digi_config_t_type;
}
...
GENMPY_UNUSED STATIC wifi_sta_info_t *mp_arr_to_wifi_sta_info_t___10__(mp_obj_t mp_arr)
{
    mp_obj_t mp_len = mp_obj_len_maybe(mp_arr);
    if (mp_len == MP_OBJ_NULL) return mp_to_ptr(mp_arr);
    mp_int_t len = mp_obj_get_int(mp_len);
...
GENMPY_UNUSED STATIC mp_obj_t mp_arr_from_wifi_sta_info_t___10__(wifi_sta_info_t *arr)
{
    mp_obj_t obj_arr[10];
...
STATIC void mp_wifi_sta_list_t_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest)
{
    ...
    if (dest[0] == MP_OBJ_NULL) {
        ...
        if (dest[1])
        {
            ...
            switch(attr)
            {
                case MP_QSTR_sta: memcpy((void*)&data->sta, mp_arr_to_wifi_sta_info_t___10__(dest[1]), sizeof(wifi_sta_info_t)*10); break; // converting to wifi_sta_info_t [10];
...
STATIC mp_obj_t mp_adc_digi_controller_config(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    const adc_digi_config_t *config = (const adc_digi_config_t *)mp_write_ptr_adc_digi_config_t(mp_args[0]);
    esp_err_t _res = ((esp_err_t (*)(const adc_digi_config_t *))lv_func_ptr)(config);
    return mp_obj_new_int(_res);
}

 

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_adc_digi_controller_config_mpobj, 1, mp_adc_digi_controller_config, adc_digi_controller_config);
    

STATIC const mp_rom_map_elem_t mp_adc_digi_config_t_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR___SIZE__), MP_ROM_PTR(MP_ROM_INT(sizeof(adc_digi_config_t))) },
    { MP_ROM_QSTR(MP_QSTR_controller_config), MP_ROM_PTR(&mp_adc_digi_controller_config_mpobj) },
    
};

STATIC MP_DEFINE_CONST_DICT(mp_adc_digi_config_t_locals_dict, mp_adc_digi_config_t_locals_dict_table);
        

STATIC const mp_rom_map_elem_t mp_adc_digi_pattern_table_t_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR___SIZE__), MP_ROM_PTR(MP_ROM_INT(sizeof(adc_digi_pattern_table_t))) },
    
};

STATIC MP_DEFINE_CONST_DICT(mp_adc_digi_pattern_table_t_locals_dict, mp_adc_digi_pattern_table_t_locals_dict_table);
...
STATIC mp_obj_t mp_esp_eth_detect_phy_addr(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    uint32_t *detected_addr = mp_array_to_u32ptr(mp_args[1]);
    esp_err_t _res = ((esp_err_t (*)(esp_eth_mediator_t *, uint32_t *))lv_func_ptr)(eth, detected_addr);
    return mp_obj_new_int(_res);
}
...
STATIC mp_obj_t mp_esp_eth_phy_new_ip101(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_esp_eth_phy_new_ip101_mpobj, 1, mp_esp_eth_phy_new_ip101, esp_eth_phy_new_ip101);
    
/* Reusing esp_eth_phy_new_ip101 for esp_eth_phy_new_rtl8201 */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_esp_eth_phy_new_rtl8201_mpobj, 1, mp_esp_eth_phy_new_ip101, esp_eth_phy_new_rtl8201);
    
/* Reusing esp_eth_phy_new_ip101 for esp_eth_phy_new_lan8720 */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_esp_eth_phy_new_lan8720_mpobj, 1, mp_esp_eth_phy_new_ip101, esp_eth_phy_new_lan8720);
    
/* Reusing esp_eth_phy_new_ip101 for esp_eth_phy_new_dp83848 */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_VAR(mp_esp_eth_phy_new_dp83848_mpobj, 1, mp_esp_eth_phy_new_ip101, esp_eth_phy_new_dp83848);
...
/*
 * espidf extension definition for:
 * inline static int lldesc_get_required_num(int data_size)
 */

STATIC mp_obj_t mp_lldesc_get_required_num(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    int data_size = (int)mp_obj_get_int(mp_args[0]);
    int _res = ((int (*)(int))lv_func_ptr)(data_size);
    return mp_obj_new_int(_res);
}

 

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_lldesc_get_required_num_mpobj, 1, mp_lldesc_get_required_num, lldesc_get_required_num);
...
STATIC mp_obj_t mp_lldesc_setup_link(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    bool isrx = mp_obj_is_true(mp_args[3]);
    ((void (*)(lldesc_t *, const void *, int, bool))lv_func_ptr)(out_desc_array, buffer, size, isrx);
    return mp_const_none;
}

 

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_lldesc_setup_link_mpobj, 4, mp_lldesc_setup_link, lldesc_setup_link);
...
STATIC mp_obj_t mp_spi_bus_initialize(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    esp_err_t _res = ((esp_err_t (*)(spi_host_device_t, const spi_bus_config_t *, int))lv_func_ptr)(host_id, bus_config, dma_chan);
    return mp_obj_new_int(_res);
}
...
STATIC mp_obj_t mp_heap_caps_aligned_alloc(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    size_t size = (size_t)mp_obj_get_int(mp_args[1]);
    int caps = (int)mp_obj_get_int(mp_args[2]);
    void * _res = ((void *(*)(size_t, size_t, int))lv_func_ptr)(alignment, size, caps);
    return ptr_to_mp((void*)_res);
}
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_heap_caps_calloc_mpobj, 3, mp_heap_caps_calloc, heap_caps_calloc);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_adc_gpio_init_mpobj, 2, mp_adc_gpio_init, adc_gpio_init);
...
STATIC mp_obj_t mp_adc_digi_init(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_adc_digi_init_mpobj, 0, mp_adc_digi_init, adc_digi_init);
    
/* Reusing adc_digi_init for adc_digi_deinit */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_adc_digi_deinit_mpobj, 0, mp_adc_digi_init, adc_digi_deinit);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_adc_i2s_mode_init_mpobj, 2, mp_adc_gpio_init, adc_i2s_mode_init);
...
STATIC inline void* mp_write_ptr_i2s_config_t(mp_obj_t self_in)
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(cast(self_in, get_mp_i2s_config_t_type()));
    return (i2s_config_t*)self->data;
}

#define mp_write_i2s_config_t(struct_obj) *((i2s_config_t*)mp_write_ptr_i2s_config_t(struct_obj))

STATIC inline mp_obj_t mp_read_ptr_i2s_config_t(void *field)
{
    return lv_to_mp_struct(get_mp_i2s_config_t_type(), field);
}
...
{
    mp_lv_struct_t *self = MP_OBJ_TO_PTR(self_in);
    GENMPY_UNUSED i2s_config_t *data = (i2s_config_t*)self->data;
...
STATIC MP_DEFINE_CONST_OBJ_TYPE(
    mp_i2s_config_t_type,
    MP_QSTR_i2s_config_t,
    MP_TYPE_FLAG_NONE,
    ...
    locals_dict, &mp_i2s_config_t_locals_dict,
    buffer, mp_blob_get_buffer,
    parent, &mp_lv_base_struct_type
);
...
{
    i2s_port_t i2s_num = (int)mp_obj_get_int(mp_args[0]);
    const i2s_config_t *i2s_config = (const i2s_config_t *)mp_write_ptr_i2s_config_t(mp_args[1]);
...
STATIC const mp_rom_map_elem_t mp_i2s_config_t_locals_dict_table[] = {
    { MP_ROM_QSTR(MP_QSTR___SIZE__), MP_ROM_PTR(MP_ROM_INT(sizeof(i2s_config_t))) },
...
STATIC mp_obj_t mp_esp_eth_transmit(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    uint32_t length = (uint32_t)mp_obj_get_int(mp_args[2]);
    esp_err_t _res = ((esp_err_t (*)(esp_eth_handle_t, void *, uint32_t))lv_func_ptr)(hdl, buf, length);
    return mp_obj_new_int(_res);
}
...
STATIC mp_obj_t mp_esp_eth_new_netif_glue(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    ...
    void * _res = ((void *(*)(esp_eth_handle_t))lv_func_ptr)(eth_hdl);
    return ptr_to_mp((void*)_res);
}
...
{
    void *glue = mp_to_ptr(mp_args[0]);
    esp_err_t _res = ((esp_err_t (*)(void *))lv_func_ptr)(glue);
    return mp_obj_new_int(_res);
}
...
/* Reusing esp_eth_del_netif_glue for esp_eth_set_default_handlers */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_esp_eth_set_default_handlers_mpobj, 1, mp_esp_eth_del_netif_glue, esp_eth_set_default_handlers);
    
/* Reusing esp_eth_del_netif_glue for esp_eth_clear_default_handlers */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_esp_eth_clear_default_handlers_mpobj, 1, mp_esp_eth_del_netif_glue, esp_eth_clear_default_handlers);
...
STATIC mp_obj_t mp_soc_has_cache_lock_bug(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_soc_has_cache_lock_bug_mpobj, 0, mp_soc_has_cache_lock_bug, soc_has_cache_lock_bug);
...
/*
 * Array convertors for esp_netif_sta_info_t [10]
 */

GENMPY_UNUSED STATIC esp_netif_sta_info_t *mp_arr_to_esp_netif_sta_info_t___10__(mp_obj_t mp_arr)
{
    mp_obj_t mp_len = mp_obj_len_maybe(mp_arr);
    if (mp_len == MP_OBJ_NULL) return mp_to_ptr(mp_arr);
    mp_int_t len = mp_obj_get_int(mp_len);
...
GENMPY_UNUSED STATIC mp_obj_t mp_arr_from_esp_netif_sta_info_t___10__(esp_netif_sta_info_t *arr)
{
    mp_obj_t obj_arr[10];
    for (size_t i=0; i<10; i++){
...
STATIC void mp_esp_netif_sta_list_t_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest)
{
    ...
    if (dest[0] == MP_OBJ_NULL) {
        ...
        switch(attr)
        {
            case MP_QSTR_sta: dest[0] = mp_arr_from_esp_netif_sta_info_t___10__(data->sta); break; // converting from esp_netif_sta_info_t [10];
            case MP_QSTR_num: dest[0] = mp_obj_new_int(data->num); break; // converting from int;
            default: call_parent_methods(self_in, attr, dest); // fallback to locals_dict lookup
        }
    } else {
        if (dest[1])
        {
            ...
            switch(attr)
            {
                case MP_QSTR_sta: memcpy((void*)&data->sta, mp_arr_to_esp_netif_sta_info_t___10__(dest[1]), sizeof(esp_netif_sta_info_t)*10); break; // converting to esp_netif_sta_info_t [10];
                case MP_QSTR_num: data->num = (int)mp_obj_get_int(dest[1]); break; // converting to int;
                default: return;
            }
...
/* Reusing adc_digi_init for tcpip_adapter_set_default_eth_handlers */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_tcpip_adapter_set_default_eth_handlers_mpobj, 0, mp_adc_digi_init, tcpip_adapter_set_default_eth_handlers);
...
/* Reusing adc_digi_init for tcpip_adapter_clear_default_wifi_handlers */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_tcpip_adapter_clear_default_wifi_handlers_mpobj, 0, mp_adc_digi_init, tcpip_adapter_clear_default_wifi_handlers);
    
/* Reusing adc_digi_init for tcpip_adapter_clear_default_eth_handlers */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_tcpip_adapter_clear_default_eth_handlers_mpobj, 0, mp_adc_digi_init, tcpip_adapter_clear_default_eth_handlers);
...
/* Reusing adc_digi_init for tcpip_adapter_set_default_wifi_handlers */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_tcpip_adapter_set_default_wifi_handlers_mpobj, 0, mp_adc_digi_init, tcpip_adapter_set_default_wifi_handlers);
    
/* Reusing adc_digi_init for esp_netif_init */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_esp_netif_init_mpobj, 0, mp_adc_digi_init, esp_netif_init);
    
/* Reusing adc_digi_init for esp_netif_deinit */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_esp_netif_deinit_mpobj, 0, mp_adc_digi_init, esp_netif_deinit);
...
/* Reusing adc_digi_init for mdns_init */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_mdns_init_mpobj, 0, mp_adc_digi_init, mdns_init);
...
STATIC mp_obj_t mp_mdns_service_instance_name_set(size_t mp_n_args, const mp_obj_t *mp_args, void *lv_func_ptr)
{
    const char *service_type = (const char *)(char*)convert_from_str(mp_args[0]);
    const char *proto = (const char *)(char*)convert_from_str(mp_args[1]);
    const char *instance_name = (const char *)(char*)convert_from_str(mp_args[2]);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_mdns_service_instance_name_set_mpobj, 3, mp_mdns_service_instance_name_set, mdns_service_instance_name_set);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_mdns_service_txt_item_set_mpobj, 4, mp_mdns_service_txt_item_set, mdns_service_txt_item_set);
    
/* Reusing mdns_service_instance_name_set for mdns_service_txt_item_remove */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_mdns_service_txt_item_remove_mpobj, 3, mp_mdns_service_instance_name_set, mdns_service_txt_item_remove);
    
/* Reusing adc_digi_init for mdns_service_remove_all */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_mdns_service_remove_all_mpobj, 0, mp_adc_digi_init, mdns_service_remove_all);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_esp_http_client_set_password_mpobj, 2, mp_esp_http_client_set_password, esp_http_client_set_password);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_esp_http_client_open_mpobj, 2, mp_esp_http_client_open, esp_http_client_open);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_esp_http_client_fetch_headers_mpobj, 1, mp_esp_http_client_fetch_headers, esp_http_client_fetch_headers);
...
STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_esp_http_client_get_status_code_mpobj, 1, mp_esp_http_client_fetch_headers, esp_http_client_get_status_code);
    
/* Reusing esp_http_client_fetch_headers for esp_http_client_get_content_length */

STATIC MP_DEFINE_CONST_LV_FUN_OBJ_STATIC_VAR(mp_esp_http_client_get_content_length_mpobj, 1, mp_esp_http_client_fetch_headers, esp_http_client_get_content_length);
...
STATIC const mp_rom_map_elem_t espidf_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_lldesc_get_required_num), MP_ROM_PTR(&mp_lldesc_get_required_num_mpobj) },
    ...
    { MP_ROM_QSTR(MP_QSTR_lldesc_setup_link), MP_ROM_PTR(&mp_lldesc_setup_link_mpobj) },
    ...
    { MP_ROM_QSTR(MP_QSTR_adc_gpio_init), MP_ROM_PTR(&mp_adc_gpio_init_mpobj) },
    ...
    { MP_ROM_QSTR(MP_QSTR_adc_digi_init), MP_ROM_PTR(&mp_adc_digi_init_mpobj) },
    { MP_ROM_QSTR(MP_QSTR_adc_digi_deinit), MP_ROM_PTR(&mp_adc_digi_deinit_mpobj) },
    ...
    { MP_ROM_QSTR(MP_QSTR_soc_has_cache_lock_bug), MP_ROM_PTR(&mp_soc_has_cache_lock_bug_mpobj) },
    ...
    { MP_ROM_QSTR(MP_QSTR_ADC_DIGI_FORMAT), MP_ROM_PTR(&mp_lv_ADC_DIGI_FORMAT_type_base) },
    ...
    { MP_ROM_QSTR(MP_QSTR_PDM_PCM_CONV), MP_ROM_PTR(&mp_lv_PDM_PCM_CONV_type_base) },
    ...
    { MP_ROM_QSTR(MP_QSTR_PCNT_MODE), MP_ROM_PTR(&mp_lv_PCNT_MODE_type_base) },
    { MP_ROM_QSTR(MP_QSTR_PCNT_COUNT), MP_ROM_PTR(&mp_lv_PCNT_COUNT_type_base) },
    ...
    { MP_ROM_QSTR(MP_QSTR_adc_digi_config_t), MP_ROM_PTR(&mp_adc_digi_config_t_type) },
    { MP_ROM_QSTR(MP_QSTR_adc_digi_pattern_table_t), MP_ROM_PTR(&mp_adc_digi_pattern_table_t_type) },
