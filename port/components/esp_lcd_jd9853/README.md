...
| :------------: | :---------------------: | :------------: | :---------------: |
| jd9853        | SPI                     | esp_lcd_jd9853     | [Specification](https://cdn-shop.adafruit.com/datasheets/jd9853.pdf) |
...
```bash
idf.py add-dependency "espressif/esp_lcd_jd9853^2.0.0"
```
...
```c
    ...
    const spi_bus_config_t bus_config = jd9853_PANEL_BUS_SPI_CONFIG(EXAMPLE_PIN_NUM_LCD_PCLK, EXAMPLE_PIN_NUM_LCD_MOSI,
                                                                     EXAMPLE_LCD_H_RES * 80 * sizeof(uint16_t));
    ESP_ERROR_CHECK(spi_bus_initialize(EXAMPLE_LCD_HOST, &bus_config, SPI_DMA_CH_AUTO));

    ESP_LOGI(TAG, "Install panel IO");
    esp_lcd_panel_io_handle_t io_handle = NULL;
    const esp_lcd_panel_io_spi_config_t io_config = jd9853_PANEL_IO_SPI_CONFIG(EXAMPLE_PIN_NUM_LCD_CS, EXAMPLE_PIN_NUM_LCD_DC,
...
// };
    ...
    // jd9853_vendor_config_t vendor_config = {  // Uncomment these lines if use custom initialization commands
    //     .init_cmds = lcd_init_cmds,
    //     .init_cmds_size = sizeof(lcd_init_cmds) / sizeof(jd9853_lcd_init_cmd_t),
    // };
...
```c
#include "esp_lcd_jd9853_init_cmds_1.h"
```
...
```c
    ...
    jd9853_vendor_config_t vendor_config = {
        .init_cmds = jd9853_lcd_init_vendor,
        .init_cmds_size = sizeof(jd9853_lcd_init_vendor) / sizeof(jd9853_lcd_init_cmd_t),
    };
