...
def lv_timer_cb(timer):
    if not timer_flag:
        ...
        gui.draw_line(87, 86, 97, 86, size=4, color=0x00DDFF, draw=0)
        gui.draw_line(223, 86, 233, 86, size=4, color=0x00DDFF, draw=0)
        gui.draw_line(160, 13, 160, 23, size=4, color=0x00DDFF, draw=0)
        gui.draw_line(160, 149, 160, 159, size=4, color=0x00DDFF, draw=0)
        gui.draw_line(130, 86, 190, 86, size=4, color=0x00DDFF, draw=0)
        gui.draw_line(160, 56, 160, 116, size=4, color=0x00DDFF, draw=0)
