...
static mp_obj_t lvgl_esp32_Display_init(mp_obj_t self_ptr)
{
    ...
    ESP_ERROR_CHECK(esp_lcd_panel_set_gap(self->panel, self->gap_x, self->gap_y));
...
)
{
    ...
    static const mp_arg_t allowed_args[] = {
        ...
        { MP_QSTR_gap_x, MP_ARG_INT | MP_ARG_REQUIRED , {.u_int = 0}},
        { MP_QSTR_gap_y, MP_ARG_INT | MP_ARG_REQUIRED , {.u_int = 0}},
    ...
    self->gap_x = args[ARG_gap_x].u_int;
    self->gap_y = args[ARG_gap_y].u_int;
